---
version: 1
slug: "frontend-src-app-overview-researchhomeclient-tsx"
primary_target: "frontend/src/app/overview/ResearchHomeClient.tsx"
related_targets: ["frontend/src/app/overview/ResearchHome.module.css","frontend/src/components/AppHeader.tsx","frontend/src/components/AppHeader.module.css"]
---

# Retired research home

Mode: Operate

The `/overview` index now redirects to `/workspace`. The former summary dashboard is intentionally not part of the active entry flow; this record remains only to explain the retired surface and prevent it from being reintroduced as a default landing page.
